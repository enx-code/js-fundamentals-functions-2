...
function remainingBakeTime(minInOven) {
    
    let timeRemain = bakingTime() - minInOven
...
function calculatePreparationTime(numOfLayers) {
    let total = numOfLayers * 3
    return total
}
console.log(calculatePreparationTime(0))
...
function totalTimeSpent(numOfLayers, minInOven) {
    
    let allTimeSpent = calculatePreparationTime(numOfLayers) + minInOven 
    return allTimeSpent
}
console.log(totalTimeSpent(3, 40))
console.log(totalTimeSpent(2, 20))
console.log(totalTimeSpent(0, 0))
